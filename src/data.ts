...
export const CROPS: Crop[] = [
  ...
  { id: 'onion', name: { en: 'Onion', hi: 'प्याज', gu: 'ડુંગળી' }, icon: '🧅', temp: '0°C - 2°C' },
  { id: 'garlic', name: { en: 'Garlic', hi: 'लहसुन', gu: 'લસણ' }, icon: '🧄', temp: '0°C - 2°C' },
  { id: 'chili', name: { en: 'Green Chili', hi: 'हरी मिर्च', gu: 'લીલા મરચા' }, icon: '🌶️', temp: '6°C - 10°C' },
  { id: 'banana', name: { en: 'Banana', hi: 'केला', gu: 'કેળા' }, icon: '🍌', temp: '12°C - 14°C' },
  { id: 'mango', name: { en: 'Mango', hi: 'आम', gu: 'કેરી' }, icon: '🥭', temp: '10°C - 13°C' },
...
export const VOICE_ALIASES: Record<string, string[]> = {
  ...
  onion: ['onion', 'प्याज', 'ડુંગળી'],
  garlic: ['garlic', 'लहसुन', 'લસણ'],
  chili: ['chili', 'chilli', 'green chili', 'हरी मिर्च', 'લીલા મરચા'],
  banana: ['banana', 'केला', 'કેળા'],
  mango: ['mango', 'आम', 'કેરી', 'fruit', 'fruits', 'फल'],
